...
var checkCollisions = function() {
    ...
    for (var i = 0; i < objectinst.length; i++) {
        ...
        enemy = allEnemies[i];
        if (player.x < allEnemies[i].x + allEnemies[i].enemyWidth && player
            .x + player.playerWidth > allEnemies[i].x && player.y <
            allEnemies[i].y + allEnemies[i].enemyHeight && player.playerHeight +
